/*
 ...
 $Id: ObjReaper.cc,v 1.1.2.2 2007/09/27 09:02:22 paule Exp $                                                       
...
ObjReaper::ObjReaper(ServiceApp &app_)
    : app(app_) {
}
...
void ObjReaper::operator()() {
  ...
  while (!app.shutdown()) {
    ...
    app.subscribers.removeTerminatedSubscribers();
  }
}
