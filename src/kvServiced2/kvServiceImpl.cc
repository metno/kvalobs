...
KvServiceImpl::subscribeDataNotify(const DataSubscribeInfo& info,
  ...
  LOGINFO(
      "New <datanotify> subscriber registred with subscriberid ("<< subid<<")");
...
KvServiceImpl::subscribeData(const DataSubscribeInfo& info,
  ...
  LOGINFO("New <data> subscriber registred with subscriberid ("<< subid<<")");
...
KvServiceImpl::subscribeKvHint(CKvalObs::CService::kvHintSubscriber_ptr sub) {
  ...
  LOGINFO("New <hint> subscriber registred with subscriberid ("<< subid<<")");
...
char*
KvServiceExtImpl::registerDataNotify(
    const char* id, CKvalObs::CService::kvDataNotifySubscriberExt_ptr sub) {
  return CORBA::string_dup("");
}

char*
KvServiceExtImpl::registerData(
    const char* id, CKvalObs::CService::kvDataSubscriberExt_ptr sub) {
...
CORBA::Boolean KvServiceExtImpl::getDataExt(
