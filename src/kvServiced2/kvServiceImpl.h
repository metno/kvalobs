/*
  ...
  $Id: kvServiceImpl.h,v 1.1.2.2 2007/09/27 09:02:22 paule Exp $                                                       
...
class KvServiceImpl: 
	public virtual POA_CKvalObs::CService::kvService,
...
class KvServiceExtImpl: 
	public virtual KvServiceImpl,
	public virtual POA_CKvalObs::CService::kvServiceExt
{
	public:
		KvServiceExtImpl(ServiceApp &app_): KvServiceImpl(app_)
		{
		}
		
		virtual ~KvServiceExtImpl();
  		...
  		CORBA::Boolean getDataExt(const CKvalObs::CService::WhichDataExtList& whichData,
  										  CKvalObs::CService::DataIterator_out it);
};
