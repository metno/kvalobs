...
class SubscriberData {
  ...
  typedef std::map<std::string, dnmi::thread::Thread<KvDataSubscriber> > TDataSub;
  typedef std::map<std::string, dnmi::thread::Thread<KvDataSubscriber> >::iterator ITDataSub;

  typedef std::map<std::string, dnmi::thread::Thread<KvPsDataSubscriber> > TPsDataSub;
  typedef std::map<std::string, dnmi::thread::Thread<KvPsDataSubscriber> >::iterator ITPsDataSub;

  typedef std::map<std::string, dnmi::thread::Thread<KvDataNotifySubscriber> > TDataNotifySub;
  typedef std::map<std::string, dnmi::thread::Thread<KvDataNotifySubscriber> >::iterator ITDataNotifySub;

  typedef std::map<std::string, dnmi::thread::Thread<KvPsDataNotifySubscriber> > TPsDataNotifySub;
  typedef std::map<std::string, dnmi::thread::Thread<KvPsDataNotifySubscriber> >::iterator ITPsDataNotifySub;

  typedef std::map<std::string, CKvalObs::CService::kvHintSubscriber_var> THintSub;
  typedef std::map<std::string, CKvalObs::CService::kvHintSubscriber_var>::iterator ITHintSub;
