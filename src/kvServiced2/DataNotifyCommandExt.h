...
class DataNotifyCommandExt : 
  public SubscriberCommandBase<kvskel::kvDataNotifySubscriberExt>
{
...
protected:
	...
	void buildWhatList(CKvalObs::CService::kvDataNotifySubscriberExt::WhatList &wl,
