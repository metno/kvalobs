/*
  ...
  $Id: TableInfoType404.java,v 1.1.2.2 2007/09/27 09:02:19 paule Exp $                                                       
...
public class TableInfoType404 extends TableInfoType {
    
    public TableInfoType404(){
	super("KL2KVALOBS", "404","RR_01" );
    }
