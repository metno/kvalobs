...
KvDataReceiver::KvDataReceiver(const KvDataReceiver &dr)
    : confName(dr.confName),
      dirName(dr.dirName),
      name(dr.name),
      ns(dr.ns) {
}
...
bool KvDataReceiver::decode(const std::string &confString,
