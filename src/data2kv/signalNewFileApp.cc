...
namespace {
CORBA::Boolean
globalTransientHandler(void* cooke, CORBA::ULong retries,
...
SignalNewFileApp::SignalNewFileApp(int argn, char **argv)
  ...
  cerr << "Signaling 'newfile' to the following paths in the" << endl
       << "CORBA nameserver:" << endl << "newfile:          '/" << aopath_
       << "/" << newfileApp << "'" << endl << "CORBA nameserver: "
       << getNameservice() << ">" << endl << "datadir:          " << datadir
       << endl;
}

CORBA::Object_ptr SignalNewFileApp::getRefInNS(const std::string &name_,
 ...
 */
micutil::newfilesignal_ptr SignalNewFileApp::lookUpNewfilesignal(bool forceNS,
                                                                 bool &usedNS) {
...
bool SignalNewFileApp::createFile(const std::string &station,
...
namespace {
CORBA::Boolean globalTransientHandler(void* cooke, CORBA::ULong retries,
                                      const CORBA::TRANSIENT& ex) {
