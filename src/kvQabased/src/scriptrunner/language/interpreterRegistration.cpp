...
class InterpreterControl {
 public:
  ...
  explicit InterpreterControl(InterpreterCreationFunction f)
      : f_(f) {
  }
...
std::string registerInterpreter(
    const std::string & name, InterpreterCreationFunction interpreterCreator) {
