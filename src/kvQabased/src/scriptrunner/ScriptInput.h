...
class ScriptInput {
 public:
  ...
  void add(const std::string & name, OutputIterator start,
           OutputIterator stop) {
   ...
   */
  template<class OutputIterator>
  void adds(const std::string & name, OutputIterator start,
            OutputIterator stop) {
  ...
  const NumericParameters & numeric() const {
    return numeric_;
  }
  const StringParameters & strings() const {
    return strings_;
  }
  const NumericListParameters & numericList() const {
    return numericList_;
  }
  const StringListParameters & stringList() const {
    return stringList_;
  }
