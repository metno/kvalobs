...
TEST(ScriptResultIdentifierTest, throwOnSpaceInParameter) {
  EXPECT_THROW(ScriptResultIdentifier result("X_ 0_0_corrected"),
               ScriptResultIdentifier::SyntaxError);
}

TEST(ScriptResultIdentifierTest, throwOnUndefinedCorrectionType) {
  EXPECT_THROW(ScriptResultIdentifier result("X_0_0_foo"),
               ScriptResultIdentifier::UndefinedCorrectionType);
}
