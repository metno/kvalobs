/*
  ...
  $Id: DataReceiverApp.cc,v 1.1.2.3 2007/09/27 09:02:40 paule Exp $                                                       
...
onKvDataEvent(kvservice::KvObsDataListPtr data)
{
  ...
  for(; 
    ...
    cerr << it->stationid() << " " << it->front().obstime().isoTime() 
	...
	<< c << "|" << p->level() << "|" << p->corrected() << "|" 
	<< p->controlinfo().flagstring() << "|" << p->useinfo().flagstring() 
	<< "|" << p->cfailed() << endl;
    }
  }
