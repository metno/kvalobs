...
class KvDataSubscriber: public KvSubscriberBase{
 ...
 public:
  ...
  CKvalObs::CService::kvDataSubscriber_ptr subscriber()const
    { return 
	CKvalObs::CService::kvDataSubscriber::_duplicate(subscriber_);
    }
...
typedef boost::shared_ptr<KvDataSubscriber>  
        KvDataSubscriberPtr;

typedef std::list<KvDataSubscriberPtr>       
        KvDataSubscriberList;

typedef std::list<KvDataSubscriberPtr>::iterator  
        IKvDataSubscriberList;

typedef std::list<KvDataSubscriberPtr>::const_iterator 
        CIKvDataSubscriberList;
