...
typedef boost::shared_ptr<KvDataNotifySubscriber> KvDataNotifySubscriberPtr;

typedef std::list<KvDataNotifySubscriberPtr> KvDataNotifySubscriberList;

typedef std::list<KvDataNotifySubscriberPtr>::iterator IKvDataNotifySubscriberList;

typedef std::list<KvDataNotifySubscriberPtr>::const_iterator CIKvDataNotifySubscriberList;
