...
namespace dnmi{
  namespace thread{
    ...
    public:
      ...
      explicit ThreadPoolQue(unsigned int size_, 
			     CommandQue   &q,
			     int          timeoutInSec=0);
       ...
       */
      threadKillFunc getKillFunc()const { return killFunc; }
       ...
       */
      threadHelperFunc getBeforeFunc()const{ return beforeFunc; }
       ...
       */
      threadHelperFunc getAfterFunc()const { return afterFunc; }
 
      int  getTimeout()const{ return timeout;}
      void setKillFunc(threadKillFunc func){ killFunc=func;}
      void setBeforeFunc(threadHelperFunc func){ beforeFunc=func;}
      void setAfterFunc(threadHelperFunc func){ afterFunc=func;}
      void run();
      bool killSignal();
      void join();
      bool getKillHint()const { return doKill; }
    };
