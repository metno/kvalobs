...
std::string decodeutility::VV(const std::string &spVal_) {
...
std::string decodeutility::VVKode(float m) {
  char cVV[20];
  int im;
...
std::string decodeutility::HL(const std::string &spVal_) {
  string val;
...
char decodeutility::HLKode(float m) {
  int im;
...
int decodeutility::V456(int val) {
  switch (val) {
    case 12:
      return 1;
    case 11:
...
int decodeutility::hsCode2m(int code) {
  try {
...
std::string decodeutility::hs2Code(int hs) {
  int code;
