/*
 ...
 $Id: drivermgr_test.cc,v 1.1.6.1 2007/09/27 09:02:26 paule Exp $                                                       
...
int main(int argn, char *argv[]) {
  ...
  string constr("host=rime dbname=borgem user=borgem password=borgem12");
