...
bool
setSignalHandler( int signum, void (*sigfunc)(int signum), int sa_flags, struct sigaction *oldact )
{
...
void
setSignalHandlerThrow( int signum, void (*sigfunc)(int signum), int sa_flags, struct sigaction *oldact )
{
