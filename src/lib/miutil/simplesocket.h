...
public:
    ...
    int        readln(std::string &str, 
            int timeoutInSecBetweenReceivedBytes=10);
    int        readlnExt(std::string &str, 
            int timeoutInMilliSecBetweenReceivedBytes=10000);
...
public:
    ...
    socket_status_codes::ErrorTypes errorType() { return mErrorType;}
