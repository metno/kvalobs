...
#ifndef __KVQUEUEPRODUCER_H__
#define __KVQUEUEPRODUCER_H__
...
class KvqueueProducer {
public:
  typedef std::function<void(kvalobs::subscribe::MessageId id,
  ...
  explicit KvqueueProducer(
      const std::string &topic,
      const std::list<std::string> &brokers = {"localhost"},
      ErrorHandler onFailedDelivery = [](kvalobs::subscribe::MessageId,
                                         const std::string &,
                                         const std::string &) {},
      SuccessHandler onSuccessfulDelivery = [](kvalobs::subscribe::MessageId,
                                               const std::string &) {});

  explicit KvqueueProducer(
      const KvqueueConfig &config,
      ErrorHandler onFailedDelivery = [](kvalobs::subscribe::MessageId,
                                         const std::string &,
                                         const std::string &) {},
      SuccessHandler onSuccessfulDelivery = [](kvalobs::subscribe::MessageId,
  ...
  void init(const KvqueueConfig &config, ErrorHandler onFailedDelivery,
