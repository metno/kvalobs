...
/** 
 * \brief createKafkaConsumerGroupId create a reproducible consumer group id.
 * Try to create a reproducible kafka consumer group id. It is created with use of
