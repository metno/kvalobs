...
bool LogManager::addStream(LogStream *strm) {
  return addStream("__milog_default_logger__", strm);
}

bool LogManager::addStream(const std::string &id, LogStream *strm) {
...
bool LogManager::setDefaultLogger(const std::string &id) {
  LogManager *mgr = instance();
...
bool LogManager::resetDefaultLogger() {
  LogManager *mgr = instance();
...
bool LogManager::hasLogger(const std::string &id) {
  LogManager *mgr = instance();
  priv::LoggerImpl *log;
...
bool LogManager::createLogger(const std::string &id, LogStream *strm) {
  LogManager *mgr = instance();
  priv::LoggerImpl *log;
...
void LogManager::enabled(bool en) {
  LogManager *mgr = instance();
...
void LogManager::loglevel(LogLevel ll) {
  LogManager *mgr = instance();
