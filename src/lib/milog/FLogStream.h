...
class FLogStream : public virtual milog::LogStream {
 ...
 public:
   ...
   */
  FLogStream(int nRotate, int maxSize = 102400);
   ...
   *          create a new logfile.
   */
  FLogStream(Layout *layout, int nRotate = 1, int maxSize = 102400);
   ...
   *          create a new logfile.
   */
  FLogStream(const std::string &fname, int nRotate = 1, int maxSize = 102400);
