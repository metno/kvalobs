...
class KlData {
 ...
 public:
  ...
  KlData(const std::string &v, const kvalobs::kvControlInfo &c,
         const kvalobs::kvUseInfo &u)
      : val_(v),
        cinfo_(c),
        uinfo_(u) {
  }
  ...
  KlData(const std::string &v, const std::string &c, const std::string &u)
      : val_(v),
        cinfo_(c),
        uinfo_(u) {
  }
  ...
  kvalobs::kvControlInfo cinfo() const {
    return cinfo_;
  }
  kvalobs::kvUseInfo uinfo() const {
    return uinfo_;
  }
};
