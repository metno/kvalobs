...
class Sms2 : public SmsBase {
 ...
 protected:
  int decodeV1V2V3(const std::string &what, std::string &v1, std::string &v2,
                   std::string &v3, std::string &intensitet, std::ostream &err);

  void addV1V2V3(kvalobs::decodeutil::DecodedDataElem &data,
                 const miutil::miTime &obstime, const std::string &v1,
  ...
  std::string createObsTime(const std::string &sObsTime,
