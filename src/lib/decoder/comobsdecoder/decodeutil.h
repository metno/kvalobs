...
bool dohVV(kvalobs::decodeutil::DecodedDataElem &data, const std::string &hVV);
...
void doVT(kvalobs::decodeutil::DecodedDataElem &data, const std::string &vt,
          const std::string &vt1, const std::string &vt2);
}
}
