...
bool kvalobs::decodeutil::doWdWdWd(kvalobs::decodeutil::DecodedDataElem &data,
...
bool kvalobs::decodeutil::doKvEsss(kvalobs::decodeutil::DecodedDataElem &data,
...
bool kvalobs::decodeutil::doKvNhClCmCh(
    kvalobs::decodeutil::DecodedDataElem &data, const std::string &NhClCmCh) {
  string buf;
...
bool kvalobs::decodeutil::dohVV(kvalobs::decodeutil::DecodedDataElem &data,
...
bool kvalobs::decodeutil::doNsChshs(kvalobs::decodeutil::DecodedDataElem &data,
...
bool kvalobs::decodeutil::dowwW1W2(kvalobs::decodeutil::DecodedDataElem &data,
...
void kvalobs::decodeutil::doVT(kvalobs::decodeutil::DecodedDataElem &data,
                               const std::string &vt, const std::string &vt1,
  ...
  if (!vt1.empty() && v1 != "00" && isdigit(v1[0]) && isdigit(v1[1]))
    data.addData(vt1, v1);

  if (!vt2.empty() && v2 != "00" && isdigit(v2[0]) && isdigit(v2[1]))
    data.addData(vt2, v2);
