 ...
 */
#ifndef __kvalobs_decoder_testdecoder_h__
#define  __kvalobs_decoder_testdecoder_h__
 ...
 * return allways true;
 */
class TestDecoder : public DecoderBase {
  TestDecoder();
  TestDecoder(const TestDecoder &);
  TestDecoder& operator=(const TestDecoder &);

 public:
  TestDecoder(dnmi::db::Connection &con, const ParamList &params,
