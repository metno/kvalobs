...
TestDecoder::TestDecoder(dnmi::db::Connection &con, const ParamList &params,
...
std::string TestDecoder::name() const {
  return "TestDecoder";
}

kvalobs::decoder::DecoderBase::DecodeResult TestDecoder::execute(
    std::string &msg) {
