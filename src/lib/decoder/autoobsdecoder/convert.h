...
class DataConvert {
 public:
  ...
  struct SaSdEmEi {
    ...
    static bool dataSa(kvData &data, const SaSdEmEi &sa,
                       const kvData &saSdEmTemplate);
    static bool dataSd(kvData &data, const SaSdEmEi &sd,
                       const kvData &saSdEmTemplate);
    static bool dataEm(kvData &data, const SaSdEmEi &em,
                       const kvData &saSdEmTemplate);
 ...
 private:
  ...
  bool decodeSpDef(std::vector<DataElem> &data, SplitDef *spDef,
                   const std::string &param, const std::string &val, int sensor,
                   int height, int mod);
