...
extern void bus012_( long int *length, unsigned long *kbuff, long int *ksup,
                     long int *ksec0, long int *ksec1, long int *ksec2, long int *kerr );
extern void bus0123_( long int *length, unsigned long *kbuff, long int *ksup,
                      long int *ksec0, long int *ksec1, long int *ksec2, long int *ksec3, long int *kerr );


extern void bufrex_( long int *length, unsigned long int *kbuff, long int *ksup,
                     long int *ksec0, long int *ksec1, long int *ksec2, long int *ksec3, long int *ksec4,
                     long int *kelem, char **cnames, char **cunits, long int *kvals,
                     double *values, char **cvals, long int *kerr );

extern void busel_( long int *ktdlen, long int *kdtlist, long int *ktdexlen, long int *ktdexlist, long int *kerr );
