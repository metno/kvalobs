...
int BufrDecodeKvResult::findStationid(int wmono) {
...
void BufrDecodeKvResult::setStationid(int wmono) {
  stationid_ = findStationid(wmono);
}

void BufrDecodeKvResult::add(float value, int kvparamid,
