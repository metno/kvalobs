...
struct BufrContext {
  ...
  BufrContext()
      : year(INT_MAX),
        ...
        E( INT_MAX),
        SA( INT_MAX),
        tPeriodInHours1( INT_MAX),
        tPeriodInHours2( INT_MAX),
  ...
  void addData(int kvparamid, const BufrValue &val,
               boost::function<float(double val)> transform = nullTransform,
               int hDiff = 0) {
  ...
  void setheightOfPressureSensorAboveMeanSeaLevel(const BufrValue &val) {
    if (val.getType() == BufrValue::Float) {
      if (val.getValue() != DBL_MAX) {
        heightOfPressureSensorAboveMeanSeaLevel = static_cast<float>(val
            .getValue());
      }
    }
  }
  ...
  void decodeCloudAmmount(const BufrValue &val) {
    ...
    else if (nCloudSection > 1 && verticalSignificance >= 1
        && verticalSignificance <= 4) {
      if (nCloud == 1)
    ...
    if (val.getType() == BufrValue::Float) {
      if (val.getValue() != DBL_MAX) {
        ...
        switch (tPeriodInHours1) {
          case -1:
            addData(PARAMID::RR_1, rr);
            break;
          case -3:
            addData(PARAMID::RR_3, rr);
            break;
          case -6:
            addData(PARAMID::RR_6, rr);
            break;
          case -12:
            addData(PARAMID::RR_12, rr);
            break;
          case -24:
            addData(PARAMID::RR_24, rr);
            break;
          default:
            break;
        }
  ...
  void decodeMinMaxTemperature(bool isMax, const BufrValue &val) {
    ...
    if (tPeriodInHoursDistance
        != 1|| tPeriodInHours1 == INT_MAX || tPeriodInHours2 == INT_MAX)
      return;
    ...
    if (val.getType() == BufrValue::Float) {
      if (val.getValue() != DBL_MAX) {
        ...
        switch (hPeriod) {
          case -1:
            addData((isMax ? PARAMID::TAX : PARAMID::TAN), tt, tPeriodInHours2);
            break;
          case -12:
            addData((isMax ? PARAMID::TAX_12 : PARAMID::TAN_12), tt,
                    tPeriodInHours2);
            break;
          default:
            break;
  ...
  void windGust(bool isSpeed, const BufrValue &val) {
    ...
    switch (tPeriodInMinutes) {
      case -10:
        addData((isSpeed ? PARAMID::FG_010 : PARAMID::DG_010), dd);
        break;
      case -60:
        addData((isSpeed ? PARAMID::FG_1 : PARAMID::DG_1), dd);
        break;
      case -360:
        addData((isSpeed ? PARAMID::FG_6 : PARAMID::DG_6), dd);
        break;
      case -720:
        addData((isSpeed ? PARAMID::FG_12 : PARAMID::DG_12), dd);
        break;
      default:
        break;
    }
  ...
  void windMax(bool isSpeed, const BufrValue &val) {
    ...
    switch (tPeriodInMinutes) {
      case -60:
        addData((isSpeed ? PARAMID::FX_1 : PARAMID::DX_1), dd);
        break;
      case -180:
        addData((isSpeed ? PARAMID::FX_3 : PARAMID::DX_3), dd);
        break;
      case -360:
        addData((isSpeed ? PARAMID::FX_6 : PARAMID::DX_6), dd);
        break;
      case -720:
        addData((isSpeed ? PARAMID::FX_12 : PARAMID::DX_12), dd);
        break;
      default:
        break;
    }
...
void BufrDecodeSynoptic::decode(BufrDecodeResultBase *result) {
  BufrContext cntxt;
  BufrValue bufrVal;
  int descriptor;
  ...
  while (nextDescriptor(descriptor, bufrVal)) {
    ...
    switch (descriptor) {
      case 1001:
        cntxt.II = toInt(bufrVal);
        break;
      case 1002:
        cntxt.iii = toInt(bufrVal);
        break;
      case 1015:
        cntxt.name = bufrVal.getStrValue();
        break;
      case 4001:
        cntxt.year = toInt(bufrVal);
        break;
      case 4002:
        cntxt.month = toInt(bufrVal);
        break;
      case 4003:
        cntxt.day = toInt(bufrVal);
        break;
      case 4004:
        cntxt.hour = toInt(bufrVal);
        break;
      case 4005:
        cntxt.min = toInt(bufrVal);
        break;
      case 5001:
        cntxt.latitude = toFloat(bufrVal);
        break;
      case 6001:
        cntxt.longitude = toFloat(bufrVal);
        break;
      case 7030:
        cntxt.setheightOfStationAboveMeanSeaLevel(bufrVal);
        break;  //Height of station above mean sea level
      case 7031:
        cntxt.setheightOfPressureSensorAboveMeanSeaLevel(bufrVal);
        break;  //Height of barometer above mean sea level
      case 10004:
        cntxt.addData(PARAMID::PO, bufrVal, Pa2hPa);
        break;
      case 10051:
        cntxt.addData(PARAMID::PR, bufrVal, Pa2hPa);
        break;
      case 10061:
        cntxt.addData(PARAMID::PP, bufrVal, fabsf);
        break;  //Must take absolute value of this
      case 10063:
        cntxt.addData(PARAMID::AA, bufrVal);
        break;
      case 10062:
        break;  //24 hour pressure change
      case 7004:
        break;  //Pressure (Standard level ) a3
      case 10009:
        break;  //Geopotential height of standard level
      case 12101:
        cntxt.addData(PARAMID::TA, bufrVal, kelvin2c);
        break;
      case 12103:
        cntxt.addData(PARAMID::TD, bufrVal, kelvin2c);
        break;
      case 13003:
        cntxt.addData(PARAMID::UU, bufrVal);
        break;
      case 7032:
        cntxt.setHeightOfSenorAboveLocalGround(bufrVal);
        break;  //Height of sensor above local ground
      case 20001:
        cntxt.addData(PARAMID::VV, bufrVal);
        break;
      case 13023:
        cntxt.addData(PARAMID::RR_24, bufrVal);
        break;
      case 20010:
        cntxt.addData(PARAMID::NN, bufrVal, cloudCover);
        break;
      case 8002:
        cntxt.setVerticalSignificance(bufrVal);
        break;
      case 20011:
        cntxt.decodeCloudAmmount(bufrVal);
        break;
      case 20012:
        cntxt.decodeCloudType(bufrVal);
        break;
      case 20013:
        cntxt.decodeHeightOfBaseCloud(bufrVal);
        break;
      case 20062:
        cntxt.stateOfGround(bufrVal);
        break;
      case 13013:
        cntxt.snowDepth(bufrVal);
        break;
      case 12113:
        cntxt.addData(PARAMID::TGN_12, bufrVal, kelvin2c);
        break;
      case 20003:
        cntxt.presentWeather(bufrVal);
        break;
      case 20004:
        cntxt.pastWeather(PARAMID::W1, bufrVal);
        break;
      case 20005:
        cntxt.pastWeather(PARAMID::W1, bufrVal);
        break;
      case 4024:
        cntxt.setTPeriodInHours(bufrVal);
        break;
      case 13011:
        cntxt.decodePrecipitation(bufrVal);
        break;
      case 12111:
        cntxt.decodeMinMaxTemperature(true, bufrVal);
        break;
      case 12112:
        cntxt.decodeMinMaxTemperature(false, bufrVal);
        break;
      case 8021:
        cntxt.setTimeSignificance(bufrVal);
        break;
      case 4025:
        cntxt.setTPeriodInMinutes(bufrVal);
        break;
      case 11001:
        cntxt.addData(PARAMID::DD, bufrVal);
        break;
      case 11002:
        cntxt.addData(PARAMID::FF, bufrVal);
        break;
      case 11043:
        cntxt.windGust(false, bufrVal);
        break;
      case 11041:
        cntxt.windGust(true, bufrVal);
        break;
      case 22061:
        cntxt.addData(PARAMID::SG, bufrVal);
        break;
      case 22043:
        cntxt.addData(PARAMID::TW, bufrVal, kelvin2c);
        break;
      case 2038:
        cntxt.setMetodOfWaterMeassurement(bufrVal);
        break;
      case 7063:
        cntxt.setDepthOfWaterMeassurement(bufrVal);
        break;
      case 11042:
        cntxt.windMax(true, bufrVal);
        break;
    }
  }
  ...
  miutil::miTime bufrObstime(cntxt.year, cntxt.month, cntxt.day, cntxt.hour,
                             cntxt.min);

  cerr << "Obstime: " << bufrObstime << " wmono: "
      << (cntxt.II * 1000 + cntxt.iii) << " name: " << cntxt.name << endl;
  cerr << "Position (latitude, longituide) : " << cntxt.latitude << ", "
       << cntxt.longitude << endl;

  cerr << "Data:  " << endl;
  for (DataList::iterator it = cntxt.data.begin(); it != cntxt.data.end();
      ++it) {
    cerr << "   " << PARAMID::paramName(it->paramid) << " (" << it->paramid
         << "): " << it->fVal << " h: " << it->hDiffToObstime << endl;
  }
...
BufrDecodeSynoptic::BufrDecodeSynoptic() {
}
