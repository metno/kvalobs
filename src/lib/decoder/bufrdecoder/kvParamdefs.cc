...
ParamNames paramNames[] = {
    ...
    { "DW1", 65 }, { "DW2", 66 }, { "PW1", 152 }, { "HW1", 132 },
    { "PW2", 153 }, { "HW2", 133 }, { "XIS", 11 }, { "ES", 101 }, { "RS", 17 },
    { "CI", 4 }, { "SI", 20 }, { "BI", 2 }, { "DI", 6 }, { "ZI", 21 }, {
        "TAX_12", 216 },  ///< Max.temp. (day)
    { "TAX", 215 }, { "TAN", 213 }, { "TAN_12", 214 },  ///< minimum temp. (night)
    ...
    { "FG", 83 },  ///< Max gust
    { "FG_010", 84 }, { "FG_1", 90 }, { "FG_6", 91 }, { "FG_12", 92 }, {
        "DG_010", 77 }, { "DG_1", 78 }, { "DG_6", 79 }, { "DG_12", 80 }, {
    ...
    { "FX_1", 87 }, { "FX_3", 95 }, { "FX_6", 88 }, { "FX_12", 89 }, { "DX_1",
        73 }, { "DX_3", 74 }, { "DX_6", 75 }, { "DX_12", 76 }, { "X1WD", 44 },  ///< Weather amend. since last obs
    { "X2WD", 45 },  ///< Weather amend. since last obs
    { "X3WD", 46 },  ///< Weather amend. since last obs
    { "RR_1", 106 }, { "RR_3", 107 }, { "RR_6", 108 }, { "RR_12", 109 }, {
        "RR_24", 110 },  ///< RR24
...
paramName(int paramid) {
  int i = 0;
  for (; paramNames[i].paramid; ++i)
    if (paramid == paramNames[i].paramid)
      return paramNames[i].name;

  return paramNames[i].name;  // N/A
}
