...
#include "lib/decoder/kltext/kltextentry.h"
#include "lib/decoder/kltext/kltextdecoder.h"

using kvalobs::decoder::kltextdecoder::KlTextDecoder;
...
decoderFactory(dnmi::db::Connection &con, const ParamList &params,
  ...
  try {
    dec = new KlTextDecoder(con, params, typeList, obsType, obs, decoderId);
  } catch (...) {
    return 0;
  }
