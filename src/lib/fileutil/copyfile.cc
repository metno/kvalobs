...
bool miutil::file::copyfile(FILE *srcfd, int frompos, int nByte, FILE *destfd,
                            int startpos) {
  int nRead;
  int nWrite;
  int toRead;
...
bool miutil::file::copyfile(const std::string &fromfile,
                            const std::string &tofile, bool set_mtime) {
  FILE *from;
  FILE *to;
  char buf[512];
  char *p;
...
bool miutil::file::safecopy(const std::string &fromfile,
                            const std::string &tofile, bool set_mtime) {
