...
namespace kvalobs{
  ...
  public:
     ...
     */
    kvStationInfoExt(long                 stationid,
    ...
    kvStationInfoExt(long                 stationid,
           ...
           : stationid_(stationid), obstime_(obstime), typeid_(typeId), params_( params )
        {
        }
    ...
    std::list<kvStationInfoExt::Param> params()const { return params_; }
  ...
  void populateCorbaKvStationInfoExtList( const kvalobs::kvStationInfoExtList &stList, CKvalObs::StationInfoExtList &cstList );
