...
std::string kvalobs::kvDbBase::selectAllQuery(
...
std::string kvalobs::kvDbBase::quoted(
    const boost::posix_time::ptime & timeToQuote) const {
...
boost::gregorian::date kvalobs::kvDbBase::julianDayThatYear(int addOn,
                                                            int year) const {
