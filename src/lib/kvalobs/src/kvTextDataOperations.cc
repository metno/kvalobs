...
{    
  ...
  kvTextDataFactory::kvTextDataFactory( int stationID, const miutil::miTime & obsTime, int typeID )
  ...
  kvTextData kvTextDataFactory::getData( std::string val, int paramID, const miutil::miTime & obsTime ) const
  {
    kvTextData ret( stationID_, obsTime.undef() ? obstime_ : obsTime,
		    val, paramID, miutil::miTime::nowTime(), typeID_ );
    return ret;
  }
  ...
  namespace compare
  {
    ...
    bool kvTextData_same_obs_and_parameter::operator()( const kvTextData & a, const kvTextData & b ) const
    {
      return a.stationID() == b.stationID()
    ...
    bool kvTextData_exactly_equal_ex_tbtime::operator()( const kvTextData & a, const kvTextData & b ) const
    {
