...
class ObsData {
 ...
 private:
  ...
  std::string getData(const Param &param,
 ...
 public:
  ...
  void klData(std::string &data, std::string &decoder, ParamDefsPtr paramdefs);
...
class DataHelper {
 ...
 public:
  ...
  bool nextData(std::string &data, std::string &decoder,
