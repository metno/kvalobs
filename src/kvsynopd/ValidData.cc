 ...
 */
bool
kvdatacheck::validData(const kvalobs::kvData &data)
{
...
bool 
kvdatacheck::check_fr(kvalobs::kvControlInfo &f, int paramid)
{
  int  flag;
...
bool 
kvdatacheck::check_fcc(kvalobs::kvControlInfo &f, int paramid)
{
...
bool 
kvdatacheck::check_fcp(kvalobs::kvControlInfo &f, int paramid)
{
...
bool 
kvdatacheck::check_fs(kvalobs::kvControlInfo &f, int paramid)
{
...
bool 
kvdatacheck::check_fnum(kvalobs::kvControlInfo &f, int paramid)
{
...
bool 
kvdatacheck::check_fpos(kvalobs::kvControlInfo &f, int paramid)
{
...
bool 
kvdatacheck::check_fmis(kvalobs::kvControlInfo &f, int paramid)
{
...
bool 
kvdatacheck::check_useinfo1(kvalobs::kvUseInfo  &f,int paramid)
{
