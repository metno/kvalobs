...
KvMgrCltApp::KvMgrCltApp(int argn, char **argv, const char *options[][2])
  ...
  if (val.size() == 1) {
    ...
    cerr << "No database.dbconnect specified in $KVALOBS/etc/kvalobs.conf!"
         << endl;
    exit(1);
  }
}

KvMgrCltApp::~KvMgrCltApp() {
}

bool KvMgrCltApp::sendSignalToManager(int sid, int tid,
...
void KvMgrCltApp::releaseDbConnection(dnmi::db::Connection *con) {
