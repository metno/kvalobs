/*
  ...
  $Id: WhichDataHelper.h,v 1.4.2.2 2007/09/27 09:02:46 paule Exp $                                                       
...
namespace kvservice{
  ...
  /**
   * \brief A helper class to use when you want to subscribe to data
   * and get data from a kvalobs server.
   */
