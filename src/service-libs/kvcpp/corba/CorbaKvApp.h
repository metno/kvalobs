 ...
 */
class CorbaKvApp : public KvApp, protected CorbaHelper::CorbaApp {
 protected:
 ...
 private:
  template<class SubList> bool unsubscribe(const std::string &id,
                                           SubList &subList);
 ...
 public:
   ...
   */
  CorbaKvApp(int &argc, char **argv, miutil::conf::ConfSection *conf,
   ...
   */
  static miutil::conf::ConfSection* readConf(
  ...
  CKvalObs::CService::kvServiceExt_ptr lookUpService(bool forceNS,
                                                     bool & usedNS);
