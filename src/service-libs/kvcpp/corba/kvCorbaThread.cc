/*
 ...
 $Id: kvCorbaThread.cc,v 1.2.2.4 2007/09/27 09:02:46 paule Exp $                                                       
...
KvCorbaThread::run_undetached(void*) {
  ...
  try {
    ...
    LOGFATAL(
        "Caught omniORB::fatalException:" << endl << "  file: " << fe.file() << endl << "  line: " << fe.line() << endl << "  mesg: " << fe.errmsg() << endl);
  } catch (...) {
