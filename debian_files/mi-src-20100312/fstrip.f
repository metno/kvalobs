...
c
c        output filename = input filename + '_<max_line_length>'
c
c------------------------------------------------
c  DNMI/FoU  10.02.1993  Anstein Foss
...
c--------------------------------------------
      narg=iargc()
      if(narg.lt.2) then
        write(6,*) '  usage:  fstrip <max_line_length> <file(s)>'
        stop
      end if
c
      call getarg(1,text)
...
cray..................................................
      if(ios.ne.0) then
        write(6,*) '  usage:  fstrip <max_line_length> <file>'
        stop 1
      end if
      m=len(text)
