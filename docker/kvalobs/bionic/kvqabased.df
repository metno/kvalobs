...
FROM registry.met.no/obs/kvalobs/kvbuild/staging/bionic-kvcpp-runtime:latest 
ARG DEBIAN_FRONTEND='noninteractive'
ARG kvuser=kvalobs
ARG kvuserid=5010

RUN apt-get update && apt-get --yes install \
   libperl5.26 libkvutil-perl
...
COPY docker/kvalobs/kvqabased/entrypoint.sh  /usr/bin/
